...
<body>
    <div class="container">
        ...
        <div class="inv-header">
            <div>
                <h2 style="color: #ff9b00">Mobili car rental</h2>
                <ul>
                    <li>Group 5 </li>
                    <li>Kampala</li>
                    <li>+256637998660 | contact.example@gmail.com</li>
                </ul>
                <h2>Client</h2>
                <ul>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{ $reservation->price_per_day }} UGX </td>
                        <td>{{ $reservation->total_price }} UGX </td>
                    </tr>
        ...
        <div class="inv-footer">
            ...
            <div>
                <table>
                    ...
                    <tr>
                        <th>tax</th>
                        <td>(15%) {{ intval($reservation->total_price - ($reservation->total_price * 85) / 100) }}  UGX
                        </td>
                    </tr>
                    <tr>
